...
def main(node_id, my_id, start_election, peers, peer_ids):
    ...
    def receive_messages():
        nonlocal current_leader, received_ok, has_started_election
...
if __name__ == "__main__":
    if len(sys.argv) < 6:
        print("Usage: python3 leader_selection.py <node_id> <my_id> <start_election> <peer1> <peer2> ...")
        sys.exit(1)
    ...
    if random.random() < 0.3 and start_election == '0':
        sys.exit(1)
